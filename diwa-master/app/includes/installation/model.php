...
class Installation_Model {
    ...
    private $tables = array(
        'users' => array(
            ...
            'entries' => array(
                '(id, username, password, email, country, is_admin) VALUES (1, \'myadmin\', \'9c87baa223f464954940f859bcf2e233\', \'myadmin@test.com\', \'Germany\', 1)',
                '(id, username, password, email, country, is_admin) VALUES (2, \'myuser\', \'c03437ea463eaa5cb316cff4faf35a70\', \'myuser@test.com\', \'Germany\', 0)',
            )
        ),
        'downloads' => array(
            'fields' => array(
